...
$sql = "SELECT orders.Order_ID, orders.User, orders.Quantity*products.Price from orders, products where orders.Item_ID=products.Product_ID";
...
<?php 
$query="select sum(Quantity*Price) as Total from orders, products where orders.Item_ID=products.Product_ID";
...
foreach($dats as $rol){
echo "<p align='right'><b>  Total cost of all orders: ";
echo $rol['Total'];
echo " KZT</b></p>";
}
?>
